...
g = Github("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") # Your personal token
...
def change_protected_branch_settings_test():
    repo = g.get_repo("Devops-ghpage/gh-pages")
    branch = g.get_repo("Devops-ghpage/gh-pages").get_branch("main")
    branch.edit_protection(required_approving_review_count=2, enforce_admins=True)
